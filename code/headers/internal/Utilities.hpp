...
namespace prz
{
	...
	static gltVec3 glt_vec3_from(const btVector3& vector)
	{
		return gltVec3(vector.x(), vector.y(), vector.z());
	}

	static gltVec3 extract_forward_vector_from(const Matrix44& matrix)
	{
		return gltVec4(0.f, 0.f, 1.f, 0.f) * matrix;
	}
